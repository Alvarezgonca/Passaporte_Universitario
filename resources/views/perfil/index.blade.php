        ...
        <div class="row mb-4">
            <div class="col-md-12 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p id="mudar-texto" class="text-black mb-0">Acompanhe suas informações e progresso no programa</p>
                </div>
                    ...
                    <div class="col-md-3 text-center mb-4 mb-md-0">
                        <div class="position-relative d-inline-block">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=0D8ABC&color=fff&size=200"
                                alt="Foto do aluno" class="rounded-circle img-thumbnail shadow-sm border-primary"
                    ...
                    <div class="col-md-8">
                        <div class="progress" style="height: 25px;">
                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                                role="progressbar" style="width: 55%" aria-valuenow="165" aria-valuemin="0"
                                aria-valuemax="300">
                                55% Concluído
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (darkMode == 'dark') {
                ...
                document.getElementById('mudar-texto').classList.remove('text-black');
                document.getElementById('mudar-texto').classList.add('text-white');
            } else {
                body.classList.remove('text-white');
                body.classList.add('text-black');
                document.getElementById('mudar-texto').classList.add('text-black');
                document.getElementById('mudar-texto').classList.remove('text-white');
            }
        });
